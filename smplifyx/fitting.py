...
def guess_init(model,
    ...
    for index in range(len(edge_idxs)//2): 
        diff3d.append(joints_3d[:, edge_idxs[index*2]] - joints_3d[:, edge_idxs[index*2+1]]) 
        diff2d.append(joints_2d[:, edge_idxs[index*2]] - joints_2d[:, edge_idxs[index*2+1]])
